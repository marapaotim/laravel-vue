        ...
        _c(
          ...
          [
            ...
            _c("input", {
              ...
              domProps: { value: _vm.taskForm.name },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.taskForm, "name", $event.target.value)
                }
              }
            }),
            _c("div", { staticClass: "form-group" }),
            ...
            _c("textarea", {
              ...
              staticClass: "form-control",
              attrs: { rows: "4", cols: "50", required: "required" },
          ...
          _c(
            ...
            [
              _vm._l(_vm.data, function(datum) {
                return [
                  _c("tr", { key: datum.id }, [
                    _c("td", [_vm._v(_vm._s(datum.id))]),
                    _c("td", [_vm._v(_vm._s(datum.name))]),
                    _c("td", [_vm._v(_vm._s(datum.description))]),
                    _c("td", [
                      _c(
                        "a",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.retrieveData(datum.id)
                            }
                          }
                        },
                        [_vm._v("Edit  ")]
                      ...
                      _c(
                        "a",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.deleteData(datum.id)
                            }
                          }
                        },
                        [_vm._v("Delete")]
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.prev = 0;
                            _context.next = 3;
                            return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.baseUrl);
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(this.baseUrl + '/insert', this.taskForm).then(function (response) {
                                    _this.data.unshift(response.data);
                                    _this.taskForm = {
                                        id: "",
                                        name: "",
                                        description: ""
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(this.baseUrl + '/update/' + this.taskForm.id, this.taskForm).then(function (response) {
                                    _this2.taskForm = {
                                        id: "",
                                        name: "",
                                        description: ""
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.baseUrl + '/find/' + id).then(function (response) {
                                    _this3.taskForm = response.data;
                                    _this3.insert = false;
                                }).catch(function (error) {
                                    //
                                });
                        ...
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                if (confirm("Are you sure you want to delete?")) {
                                    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.baseUrl + '/delete/' + id).then(function (response) {
                                        _this4.getAllData();
                                    }).catch(function (error) {
                                        //
                                    });
